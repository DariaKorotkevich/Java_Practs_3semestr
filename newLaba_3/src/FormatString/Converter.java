...
//        NumberFormat ff = NumberFormat.getInstance(Locale.US);
        ...
        switch (choice)
        {
            case 1:  // Ruppe Conversion
                ...
                NumberFormat f2 =NumberFormat.getCurrencyInstance(Locale.TAIWAN);

                System.out.println(f2.format(amount) + " Rupee = " + f1.format(dollar) + " Dollar");
                f1 = NumberFormat.getCurrencyInstance(Locale.UK);
                pound = amount / 88;
                System.out.println(f2.format(amount) + " Rupee = " + f1.format(pound) + " Pound");
                f1 = NumberFormat.getCurrencyInstance(Locale.FRANCE);
                euro = amount / 80;
                System.out.println(f2.format(amount) + " Rupee = " + f1.format(pound) + " Euro");

                yen = amount / 0.63;
                System.out.println(f2.format(amount) + " Rupee = " + f1.format(pound) + " Yen");

                ringgit = amount / 16;
                System.out.println(f2.format(amount) + " Rupee = " + f.format(ringgit) + " ringgit");
                break;
